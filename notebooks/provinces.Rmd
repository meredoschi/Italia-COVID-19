...
regional_provinces_cubic_rate_chart <-regional_cubic_rate_chart(local_province_data, selected_region)

regional_provinces_cubic_rate_chart<-regional_provinces_cubic_rate_chart+theme(axis.text.x = province_label_text)
