...
prov_increasing_trend<-rounded(prov_increasing_trend,c('current_perc_rate','per_capita_rate','trend'),2)

prov_increasing_trend<-translated_province_column_names(prov_increasing_trend)

prov_increasing_trend<-revised_province_column_names(prov_increasing_trend)

print(prov_increasing_trend, row.names = F)
...
prov_declining_trend<-rounded(prov_declining_trend,c('current_perc_rate','per_capita_rate','trend'),2)

prov_declining_trend<-translated_province_column_names(prov_declining_trend)

prov_declining_trend<-revised_province_column_names(prov_declining_trend)

print(prov_declining_trend, row.names = F)
...
print(rates_formatted_for_printing(local_provinces), row.names = F)  
