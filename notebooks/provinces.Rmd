...
*Per capita = total cases per 100000 (one hundred thousand) people*
...
print(select(provinces_per_capita_latest,denominazione_provincia, denominazione_regione, per_capita, totale_casi),row.names = F)
