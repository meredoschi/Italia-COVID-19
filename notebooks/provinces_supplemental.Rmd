...
total_cases_by_province<-select(provinces_data_unexpanded, dt, denominazione_provincia, totale_casi)

total_cases_by_province<-translated_column_names(total_cases_by_province)

total_cases_by_province<-arrange(total_cases_by_province, province_name, total_cases)
