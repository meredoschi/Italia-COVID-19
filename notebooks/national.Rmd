---
title: "Calculations and charts - Italy - COVID-19 Epidemic"
...
national$data<-NULL 
national_data<-expand_dt_columns(national, "nation", "total_cases")
national_data<-expand_dt_columns(national_data, "nation", "intensive_care")
national_data<-expand_dt_columns(national_data, "nation", "hospitalized_with_symptoms")
national_data<-expand_dt_columns(national_data, "nation", "home_isolation")
national_data<-expand_dt_columns(national_data, "nation", "total_discharged_healed")
national_data<-expand_dt_columns(national_data, "nation", "total_deceased")
national_data<-expand_dt_columns(national_data, "nation", "tests")
national_data<-expand_dt_columns(national_data, "nation", "positives_remaining")
write.csv(national_data,file.path(csv_exports_dir,"national_data.csv"))
national$nation<-NULL
